...
import br.com.ezzysoft.cardapiomobile.LoginActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        mostrarNotificacao(remoteMessage.getData());
//
...
//        }
    ...
    private void mostrarNotificacao(Map<String, String> mapa) {

        Intent intent = new Intent(this, MainActivity.class);
        intent.putExtra("txtnotificacao",mapa.get("body"));
