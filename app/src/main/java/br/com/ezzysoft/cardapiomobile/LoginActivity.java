...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mPasswordView, mEndereco, mPorta;
...
//            ajustes = ajustesDAO.findAjustes();
//            ip = ajustes.getIp() + ":" + ajustes.getPorta();

            try {
//                HttpURLConnection conexao = connectar("http://" + ip + "/wsrest/jfrmservices/estg/cliente/get");
//
